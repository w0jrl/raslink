...
#define	BOOST_MAX	40			/* slightly less than 7 bits */
	...
	int txoffcnt;
	int rxondelay;  
	int txoffdelay; // This is the value which RX is ignored after TX Unkey (W0SKY 20200915)
...
static struct ast_frame *usbradio_read(struct ast_channel *c)
{
	...
	if (o->txkeyed == 0)
		o->txoffcnt++; // Timer starts afer radio unkeys.
	if (o->txoffcnt > 50000)
	...
	if ( cd && sd)
	{
		...
		//Modified code for BOTH txoffdelay and rxondelay W0SKY 20200915
