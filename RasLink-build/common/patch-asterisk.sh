...
sed -i '/ \*  version/c\ \*  version 21.04 04\/01\/2021' ./apps/app_rpt.c
sed -i '/static  char \*tdesc \= "Radio Repeater \/ Remote Base  version/c\static  char \*tdesc \= "Radio Repeater \/ Remote Base  version 21.04 04\/01\/2021";' ./apps/app_rpt.c
sed -i '/ASTERISK_FILE_VERSION(__FILE__, \"\$Revision/c\ASTERISK_FILE_VERSION\(__FILE__\, \"\$Revision 210401\"\)' ./apps/app_rpt.c
