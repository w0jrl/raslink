...
sed -i '/ \*  version/c\ \*  version 21.09 09\/01\/2021' ./apps/app_rpt.c
sed -i '/static  char \*tdesc \= "Radio Repeater \/ Remote Base  version/c\static  char \*tdesc \= "Radio Repeater \/ Remote Base  version 21.09 09\/01\/2021";' ./apps/app_rpt.c
sed -i '/ASTERISK_FILE_VERSION(__FILE__, \"\$Revision/c\ASTERISK_FILE_VERSION\(__FILE__\, \"\$Revision 20210901\"\)' ./apps/app_rpt.c
