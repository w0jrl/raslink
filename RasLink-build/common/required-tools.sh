...
rpi="$(cat /proc/device-tree/model | grep -ic 'raspberry pi' &>/dev/null)"
...
apt-get -qqy --fix-missing --fix-broken install\
    ...
    curl sox libsox-fmt-all usbutils libsqlite0 libsqlite0-dev libsqlite3-dev sqlite3\
    ...
    pulseaudio osspd osspd-pulseaudio dahdi-source i2c-tools libi2c-dev python libjansson-dev\
