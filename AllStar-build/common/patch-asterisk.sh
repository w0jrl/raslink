...
sed -i '/ \*  version/c\ \*  version 19.05 05\/01\/2019' ./apps/app_rpt.c
sed -i '/static  char \*tdesc \= "Radio Repeater \/ Remote Base  version/c\static  char \*tdesc \= "Radio Repeater \/ Remote Base  version 19.05 05\/01\/2019";' ./apps/app_rpt.c
