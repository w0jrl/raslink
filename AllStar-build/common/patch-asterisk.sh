...
sed -i '/ \*  version/c\ \*  version 5.27.17 05\/27\/2017' ./apps/app_rpt.c
sed -i '/static  char \*tdesc \= "Radio Repeater \/ Remote Base  version/c\static  char \*tdesc \= "Radio Repeater \/ Remote Base  version 5.27.17 05\/27\/2017";' ./apps/app_rpt.c
