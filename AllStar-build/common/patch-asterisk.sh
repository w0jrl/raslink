...
sed -i '/ \*  version/c\ \*  version 18.09 09\/01\/2018' ./apps/app_rpt.c
sed -i '/static  char \*tdesc \= "Radio Repeater \/ Remote Base  version/c\static  char \*tdesc \= "Radio Repeater \/ Remote Base  version 18.09 09\/01\/2018";' ./apps/app_rpt.c
...
sed -i 's/define	QUEUE_SIZE	5/define	QUEUE_SIZE	3/' ./channels/chan_usbradio.c
