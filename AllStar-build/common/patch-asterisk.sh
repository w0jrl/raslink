...
sed -i '/ \*  version/c\ \*  version 17.12 12\/01\/2017' ./apps/app_rpt.c
sed -i '/static  char \*tdesc \= "Radio Repeater \/ Remote Base  version/c\static  char \*tdesc \= "Radio Repeater \/ Remote Base  version 17.12 12\/01\/2017";' ./apps/app_rpt.c
