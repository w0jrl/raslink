...
sed -i '/ \*  version/c\ \*  version 19.02 02\/01\/2019' ./apps/app_rpt.c
sed -i '/static  char \*tdesc \= "Radio Repeater \/ Remote Base  version/c\static  char \*tdesc \= "Radio Repeater \/ Remote Base  version 19.02 02\/01\/2019";' ./apps/app_rpt.c
...
sed -i 's/define	QUEUE_SIZE	3/define	QUEUE_SIZE	13/' ./channels/chan_usbradio.c
