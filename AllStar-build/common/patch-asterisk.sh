...
sed -i '/ \*  version/c\ \*  version 17.05 05\/27\/2017' ./apps/app_rpt.c
sed -i '/static  char \*tdesc \= "Radio Repeater \/ Remote Base  version/c\static  char \*tdesc \= "Radio Repeater \/ Remote Base  version 17.05 05\/27\/2017";' ./apps/app_rpt.c
